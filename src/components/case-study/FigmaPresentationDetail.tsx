...
export function FigmaPresentationDetail({
  ...
  const heroSlot = (
    <main className="px-6 2xl:px-[140px] pt-4 pb-3 md:pb-[1.5rem] max-w-[1920px] mx-auto min-h-[calc(100dvh-7rem)] md:min-h-[calc(100dvh-7.25rem)] flex flex-col relative">
      <AnimatedText
        variant="hero"
