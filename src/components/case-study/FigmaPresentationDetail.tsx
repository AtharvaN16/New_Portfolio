...
export function FigmaPresentationDetail({
  ...
  return (
    ...
    >
      ...
      <div ref={contentRef}>
        <CaseStudyHeader onClose={closePresentation} />

        {/* Title + Metadata — viewport-height section, metadata anchored to bottom */}
        ...
        {/* Hero Image — same structure as CaseStudyDetail */}
        {caseStudy.imageUrl && (
          <m.section
        ...
        {/* Abstract — centered, matches NycThirdSpacesContent style */}
        {hasAbstract && (
          <m.section
        ...
        {/* Figma deck: about:blank + replace reduces extra history; sandbox + Navigation API hook help back not step slides */}
        <m.section
          className="w-full"
