      ...
      <div className="cs-content text-left">
        ...
        <div>
            <div ref={overviewRef}>
              ...
              <div className="flex flex-col justify-start space-y-6 md:space-y-8">
                <AnimatedText
                  ...
                  alwaysAnimate={false}
                  delay={0}
                  className="text-xl md:text-2xl font-bold text-text-primary leading-tight tracking-[-0.05em] max-w-[580px]"
                />
                <p
                  className="text-base md:text-[18px] font-normal leading-normal max-w-[680px]"
            ...
            <div className="py-16 md:py-24">
              <h3
                className="text-sm md:text-base font-semibold normal-case mb-8"
                style={{ color: 'rgb(var(--color-text-tertiary))' }}
              >
                Conclusion & Reflection
              </h3>
