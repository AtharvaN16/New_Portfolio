...
const BookmarkAddIcon = () => (
  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="15" height="15" color="#000000" fill="none" stroke="#FFFFFF" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round">
    ...
    >
      <div className="flex-1 pr-8">
        <div className="flex items-center gap-3 mb-1">
          <h4 className="text-[#265D38] text-[14px] font-medium transition-colors duration-200 group-hover:text-[#1a4127] relative inline-block cursor-pointer">
            {title}
            <motion.span
          ...
          <AnimatePresence>
            {isBookmarked && (
              <motion.span
                ...
                exit={{ opacity: 0, x: -10 }}
                className="text-[#707070] text-[9px] font-bold uppercase tracking-wider"
              >
                Bookmarked
              </motion.span>
            )}
        ...
        <p className="text-[#383838] text-[12px] leading-relaxed">
          {description}
        </p>
      </div>
